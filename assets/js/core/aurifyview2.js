...
async function showTable() {
    try {
        ...
        for (const data of tableData) {
            ...
            newRow.innerHTML = `
            <td style="text-align: right; font-size: clamp(20px, 1.5vw, 30px);" id="metalInput">Gold</td>
            <td style="text-align: left; font-size:clamp(30px, 1.8vw, 40px); font-weight: 600;">${purityInput}</td>
            <td style="font-size:clamp(20px, 1.5vw, 30px);">${unitInput} ${weightInput}</td>
            <td id="buyAED" style="font-size:clamp(20px, 1.5vw, 30px);">0</td>
            <td id="sellAED" style="font-size:clamp(20px, 1.5vw, 30px);">0</td>
            `;
